...
$PAGE->set_url(new moodle_url('/local/rebdashboard/admin/index.php'));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('admin_page_title', 'local_rebdashboard'));
$PAGE->set_heading(get_string('admin_page_heading', 'local_rebdashboard'));

// Add body classes for plugin-specific page styling.
$PAGE->add_body_class('local-rebdashboard-plugin');
$PAGE->add_body_class('local-rebdashboard-admin-page');
...
$PAGE->navbar->add(get_string('pluginname', 'local_rebdashboard'));
$PAGE->navbar->add(get_string('nav_admin', 'local_rebdashboard'));
