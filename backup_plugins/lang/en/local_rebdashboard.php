...
/**
 * English language strings for local_rebdashboard.
 *
...
// Page strings.
$string['page_title'] = 'REB Dashboard';
$string['page_heading'] = 'REB Dashboard';
$string['page_welcome'] = 'Welcome to REB Dashboard';
...
$string['admin_page_heading'] = 'REB Dashboard Administration';
...
// Capability strings.
$string['rebdashboard:view'] = 'View REB Dashboard';
$string['rebdashboard:viewreports'] = 'View detailed reports';
$string['rebdashboard:manage'] = 'Manage dashboard settings';
